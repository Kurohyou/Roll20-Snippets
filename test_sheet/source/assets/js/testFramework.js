...
const environment = {
  attributes:{"template_start":"&{template:test} {{character_name=@{character_name}}} {{character_id=@{character_id}}}","main_tabs_tab":"nav-tabs-main-tabs--settings"},
  triggers: [],
  otherCharacters: {
...
registerFuncs({ kTabOnOpen },{type:['opener']});
  ...
  const actionAttributes = [];const persistentTabs = ["main_tabs_tab"];
