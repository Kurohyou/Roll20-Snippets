...
The mixins and functions included in the K-scaffold can be split into three categories of attribute/button mixins, Roll20 element mixins, and basic html elements.
